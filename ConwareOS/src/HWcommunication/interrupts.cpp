      ...
      programmableInterruptControllerSlaveDataPort(0xA1)
{
    ...
    SetInterruptDescriptorTableEntry(0x20, CodeSegment, &HandleException0x00, 0, IDT_INTERRUPT_GATE);
    SetInterruptDescriptorTableEntry(0x21, CodeSegment, &HandleException0x01, 0, IDT_INTERRUPT_GATE);
